  ...
  return (
    <main className="wrap">
      ...
      <div className="grid">
        ...
        <section className="preview"><h2>Preview Hasil</h2>{result ? <img className="result" src={result} alt="Hasil generator ATK" /> : background ? <img className="result" src={background} alt="Preview foto latar" /> : <div className="empty">Upload foto latar untuk melihat preview.</div>}<div className="status"><b>V5 Imagen 3:</b> Menggunakan endpoint resmi Google Imagen 3 (`imagen-3.0-generate-002:predict`) untuk menghasilkan gambar AI fotorealistik secara langsung.</div></section>
      </div>
    </main>
  );
}
